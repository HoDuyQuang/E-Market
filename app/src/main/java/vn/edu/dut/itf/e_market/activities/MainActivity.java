...
import vn.edu.dut.itf.e_market.fragments.ReviewListFragment;
...
//        updateNotification(0);
    ...
    private void chooseHome() {
        getSupportFragmentManager().beginTransaction().replace(R.id.content, new ReviewListFragment()).commit();
