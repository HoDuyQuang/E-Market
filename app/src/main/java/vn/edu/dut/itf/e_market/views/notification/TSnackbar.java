package vn.edu.dut.itf.e_market.views.notification;
...
public final class TSnackbar {
    ...
    public TSnackbar setIcon(int resId) {
        ((ImageView) mView.findViewById(R.id.icon)).setImageDrawable(ContextCompat.getDrawable(mContext, resId));
        return this;
    }
...
//		TSnackbar snackbar = new TSnackbar(findSuitableParent(view));
        TSnackbar snackbar = new TSnackbar((ViewGroup) view);
        Spanned result;
    ...
    public TSnackbar addIcon(int resource_id, int size) {
        ...
        tv.setCompoundDrawablesWithIntrinsicBounds(new BitmapDrawable(Bitmap.createScaledBitmap(
                ((BitmapDrawable) (mContext.getResources().getDrawable(resource_id))).getBitmap(), size, size, true)),
                null, null, null);
    ...
    private void animateViewIn() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            ...
            ViewCompat.animate(mView).translationY(0f).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR)
    ...
    private void animateViewOut(final int event) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            ViewCompat.animate(mView).translationY(-mView.getHeight())
                    .setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setDuration(ANIMATION_DURATION)
...
//			setBackgroundColor(ContextCompat.getColor(context, R.color.app_light_yellow));
        }
